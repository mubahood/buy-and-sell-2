...
class ApiUsersController
{
    ...
    {
        $data = DB::select('select *,(SELECT count(id) FROM products WHERE user_id = users.id) as products_count from users ORDER BY products_count DESC, ID DESC LIMIT 200');
