...
$users = User::where([])->orderBy('id','Desc')->limit(5)->get();
$all_users = User::count('id');
 
?>@extends('metro.layout.layout-dashboard')
@section('dashboard-content')
    <div class="row g-5 g-xl-10 mb-xl-10">
        <div class="col-md-6 col-lg-6 col-xl- mb-md-5 mb-xl-10">
            <!--begin::Card widget 4-->
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Currency-->
                            <span class="fs-4 fw-bold text-gray-400 me-1 align-self-start">UGX</span>
                            <!--end::Currency-->
                            <!--begin::Amount-->
                            @php
                                $tot= 0;
                            ...
                            @endphp
                            <span class="fs-2hx fw-bolder text-dark me-2 lh-1">{{ number_format($tot) }}</span> 
                        ...
                        <!--end::Info-->
                        <!--begin::Subtitle-->
                        <span class="text-gray-400 pt-1 fw-bold fs-6">Top categories</span>
                        <!--end::Subtitle-->
                    </div>
                    <!--end::Title-->
                </div>
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    @endphp
                        ...
                        <div class="d-flex fs-6 fw-bold align-items-center">
                            <!--begin::Bullet-->
                            <div class="bullet w-8px h-6px rounded-2 bg-{{$class}} me-3"></div>
                            <!--end::Bullet-->
                            <!--begin::Label-->
                            <div class="text-gray-500 flex-grow-1 me-4">{{$item->name}}</div>
                            <!--end::Label-->
                            <!--begin::Stats-->
                            <div class="fw-boldest text-gray-700 text-xxl-end">UGX. {{ number_format($item->tot) }}</div>
                            <!--end::Stats-->
                        </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
          ...
          <div class="card card-flush h-md-50 mb-xl-10">
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-title d-flex flex-column">
                    <!--begin::Amount-->
                    <span class="fs-2hx fw-bolder text-dark me-2 lh-1">{{$all_users}}</span>
                    <!--end::Amount-->
                    <!--begin::Subtitle-->
                    <span class="text-gray-400 pt-1 fw-bold fs-6">New Users This Month</span>
                    <!--end::Subtitle-->
                </div>
                <!--end::Title-->
            </div>
            ...
            <div class="card-body d-flex flex-column justify-content-end pe-0">
                <!--begin::Title-->
                <span class="fs-6 fw-boldest text-gray-800 d-block mb-2">Recently joined</span>
                <!--end::Title-->
                <!--begin::Users group-->
                ...
                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="{{ ($item->name) }}">
                  <span class="symbol-label bg-primary text-inverse-primary fw-bolder">{{ substr($item->name,0,1) }}</span>
              </div>
                  @endforeach
                    ...
                    <a href="#" class="symbol symbol-35px symbol-circle" data-bs-toggle="modal"
                        ...
                        <span class="symbol-label bg-light text-gray-400 fs-8 fw-bolder">+{{ ($all_users-5) }}</span>
                    </a>
                </div>
                <!--end::Users group-->
            </div>
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--end::Currency-->
                            <!--begin::Amount-->
                            <span class="fs-2hx fw-bolder text-dark me-2 lh-1">20,500</span>
                            <!--end::Amount-->
                            <!--begin::Badge-->
                            <span class="badge badge-success fs-6 lh-1 py-1 px-2 d-flex flex-center" style="height: 22px">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/209.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/197.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/178.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/22.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/24.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/71.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/41.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/63.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/59.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/10.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/96.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/media/stock/ecommerce/13.gif" class="w-50px ms-n1"
                                                    alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                        ...
                        <tbody class="fw-bolder text-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="text-end">12 February 2022, 11:00 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="text-end">12 February 2022, 10:08 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="text-end">12 February 2022, 7:00 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="text-end">11 February 2022, 11:00 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="text-end">10 February 2022, 11:00 am</td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="text-end">9 February 2022, 11:00 am</td>
                                <td class="text-end">
                                    <a href="" class="text-dark text-hover-primary">Brian Cox</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-end">6 February 2022, 11:00 am</td>
                                <td class="text-end">
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    ...
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="btn btn-sm btn-light">Order
                            Details</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
