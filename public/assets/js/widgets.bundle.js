...
var KTChartsWidget12 = function() {
    var e = function(e, t, a, r) {
        ...
        if (i) {
            var o = parseInt(KTUtil.css(i, "height")),
                s = (KTUtil.getCssVariableValue("--bs-gray-900"), KTUtil.getCssVariableValue("--bs-border-dashed-color")),
                l = { series: [{ name: "Net Profit", data: a }], chart: { fontFamily: "inherit", type: "bar", height: o, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["22%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: ["labelColor"] } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["Grossey", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" }, formatter: function(e) { return parseInt(e) + "K" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return "$" + e + " thousands" } } }, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")], grid: { borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } },
                n = new ApexCharts(i, l),
                d = !1,
                c = document.querySelector(e);
            !0 === r && (n.render(), d = !0), c.addEventListener("shown.bs.tab", (function(e) { 0 == d && (n.render(), d = !0) }))
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var r = [{ year: "2003", cars: 1587, motorcycles: 650, bicycles: 121 }, { year: "2004", cars: 1567, motorcycles: 683, bicycles: 146 }, { year: "2005", cars: 1617, motorcycles: 691, bicycles: 138 }, { year: "2006", cars: 1630, motorcycles: 642, bicycles: 127 }, { year: "2007", cars: 1660, motorcycles: 699, bicycles: 105 }, { year: "2008", cars: 1683, motorcycles: 721, bicycles: 109 }, { year: "2009", cars: 1691, motorcycles: 737, bicycles: 112 }, { year: "2010", cars: 1298, motorcycles: 680, bicycles: 101 }, { year: "2011", cars: 1275, motorcycles: 664, bicycles: 97 }, { year: "2012", cars: 1246, motorcycles: 648, bicycles: 93 }, { year: "2013", cars: 1318, motorcycles: 697, bicycles: 111 }, { year: "2014", cars: 1213, motorcycles: 633, bicycles: 87 }, { year: "2015", cars: 1199, motorcycles: 621, bicycles: 79 }, { year: "2016", cars: 1110, motorcycles: 210, bicycles: 81 }, { year: "2017", cars: 1165, motorcycles: 232, bicycles: 75 }, { year: "2018", cars: 1145, motorcycles: 219, bicycles: 88 }, { year: "2019", cars: 1163, motorcycles: 201, bicycles: 82 }, { year: "2020", cars: 1180, motorcycles: 285, bicycles: 87 }, { year: "2021", cars: 1159, motorcycles: 277, bicycles: 71 }],
                        i = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "year", startLocation: .5, endLocation: .5, renderer: am5xy.AxisRendererX.new(t, {}), tooltip: am5.Tooltip.new(t, {}) }));
                    i.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), i.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), i.data.setAll(r);
                    var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));

                    function s(e, s, l) {
                        var n = a.series.push(am5xy.LineSeries.new(t, { name: e, xAxis: i, yAxis: o, stacked: !0, valueYField: s, categoryXField: "year", fill: am5.color(l), tooltip: am5.Tooltip.new(t, { pointerOrientation: "horizontal", labelText: "[bold]{name}[/]\n{categoryX}: {valueY}" }) }));
                    ...
                    var l = i.makeDataItem({ category: "2016", endCategory: "2021" });
                    i.createAxisRange(l), l.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), strokeOpacity: .5, strokeDasharray: [3] }), l.get("axisFill").setAll({ fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), fillOpacity: .1 }), l.get("label").setAll({ inside: !0, text: "Fines increased", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 });
                    var n = i.makeDataItem({ category: "2021" });
                    i.createAxisRange(n), n.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-danger")), strokeOpacity: 1, strokeDasharray: [3] }), n.get("label").setAll({ inside: !0, text: "Fee introduced", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 }), a.appear(1e3, 100)
                }))
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    i.labels.template.setAll({ radius: 10 }), i.grid.template.setAll({ forceHidden: !0 });
                    var o = a.xAxes.push(am5xy.ValueAxis.new(t, { renderer: i, min: 0, max: 100, strictMinMax: !0, numberFormat: "#'%'", tooltip: am5.Tooltip.new(t, {}) })),
                    ...
                    l.data.setAll(r);
                    var n = a.series.push(am5radar.RadarColumnSeries.new(t, { xAxis: o, yAxis: l, clustered: !1, valueXField: "full", categoryYField: "category", fill: t.interfaceColors.get("alternativeBackground") }));
                    n.columns.template.setAll({ width: am5.p100, fillOpacity: .08, strokeOpacity: 0, cornerRadius: 20 }), n.data.setAll(r);
                    var d = a.series.push(am5radar.RadarColumnSeries.new(t, { xAxis: o, yAxis: l, clustered: !1, valueXField: "value", categoryYField: "category" }));
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var a = t.container.children.push(am5xy.XYChart.new(t, { panX: !1, panY: !1, layout: t.verticalLayout })),
                        ...
                        i = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "country", renderer: am5xy.AxisRendererX.new(t, { minGridDistance: 30 }), bullet: function(e, t, a) { return am5xy.AxisBullet.new(e, { location: .5, sprite: am5.Picture.new(e, { width: 24, height: 24, centerY: am5.p50, centerX: am5.p50, src: a.dataContext.icon }) }) } }));
                    i.get("renderer").labels.template.setAll({ paddingTop: 20, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), i.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), i.data.setAll(r);
                    var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                    o.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), o.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) });
                    var s = a.series.push(am5xy.ColumnSeries.new(t, { xAxis: i, yAxis: o, valueYField: "visits", categoryXField: "country" }));
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var i = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "country", renderer: am5xy.AxisRendererX.new(t, { minGridDistance: 30 }) }));
                    i.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), i.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), i.data.setAll(r);
                    var o = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                    ...
                    var n = a.series.push(am5xy.ColumnSeries.new(t, { xAxis: i, yAxis: o, valueYField: "visits", categoryXField: "country" }));
                    ...
                    var d = a.series.push(am5xy.LineSeries.new(t, { xAxis: i, yAxis: l, valueYField: "pareto", categoryXField: "country", stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")), maskBullets: !1 }));
        ...
        ! function() {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = { series: [{ name: "Net Profit", data: [54, 42, 75, 110, 23, 87, 50] }], chart: { fontFamily: "inherit", type: "bar", height: t, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["28%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: [a] } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["QA Analysis", "Marketing", "Web Dev", "Maths", "Front-end Dev", "Physics", "Phylosophy"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" }, formatter: function(e) { return parseInt(e) + "H" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return "$" + e + " thousands" } } }, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")], grid: { borderColor: r, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } },
                    o = new ApexCharts(e, i);
                setTimeout((function() { o.render() }), 200)
            }
        }()
    }
};
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var i = a.series.push(am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, include: ["US", "BR", "RU"] }));
                    i.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }), am5.ColorSet.new(t, {}), i.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), i.mapPolygons.template.states.create("hover", { fill: t.interfaceColors.get("primaryButtonHover") }), i.mapPolygons.template.states.create("active", { fill: t.interfaceColors.get("primaryButtonHover") }), a.chartContainer.get("background").events.on("click", (function() { a.goHome() })), a.appear(1e3, 100)
                }))
            }
        }()
    }
...
var KTSlidersWidget1 = function() {
    ...
    return {
        init: function() {
            ...
            t && t.addEventListener("slid.bs.carousel", (function(t) { 1 === t.to && e("#kt_slider_widget_1_chart_2", 55), 2 === t.to && e("#kt_slider_widget_1_chart_3", 25) }))
        }
    }
}();
...
var KTSlidersWidget3 = function() {
    ...
    return {
        init: function() {
            ...
            t && t.addEventListener("slid.bs.carousel", (function(t) { 1 === t.to && e("#kt_slider_widget_3_chart_2", [18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]) }))
        }
    }
}();
...
var KTTimelineWidget2 = function() {
    var e = function(e, t, a, r) {
        ...
        if (i) {
            ...
            var o = { series: a, chart: { type: "donut", width: 200 }, colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-danger")], dataLabels: { style: { fontSize: "10px" } }, stroke: { width: 0 }, labels: ["Sales", "Sales", "Sales", "Sales"], legend: { show: !1 }, fill: { type: "false" } },
                s = new ApexCharts(i, o),
                l = !1,
                n = document.querySelector(e);
            !0 === r && (s.render(), l = !0), n.addEventListener("shown.bs.tab", (function(e) { 0 == l && (s.render(), l = !0) }))
        }
    };
    return { init: function() { e("#kt_timeline_widget_2_tab_1", "#kt_timeline_widget_2_chart_1", [10.6, 100, 6.8, 2], !0), e("#kt_timeline_widget_2_tab_2", "#kt_timeline_widget_2_chart_2", [70, 13, 11, 2], !1) } }
}();
            ...
            (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({ info: !1, order: [], paging: !1, pageLength: !1 }), (() => {
                ...
                e.forEach((r => {
                    r.addEventListener("click", (i => {
                        ...
                        e.forEach((e => { e.classList.remove(...a), e.classList.add("text-muted") })), r.classList.remove("text-muted"), r.classList.add(...a), "Show All" === o ? t.search("").draw() : t.search(o).draw()
                    }))
                }))
            })(), a())
        }
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                ...
                (a = r.cloneNode(!0)).classList.remove("d-none"), r.parentNode.removeChild(r), (t = $(e).DataTable({ info: !1, order: [], lengthChange: !1, pageLength: 6, ordering: !1, paging: !1, columnDefs: [{ orderable: !1, targets: 0 }, { orderable: !1, targets: 6 }] })).on("draw", (function() { l(), o() }))
            })(), document.querySelector('[data-kt-table-widget-4="search"]').addEventListener("keyup", (function(e) { t.search(e.target.value).draw() })), r(), o())
        }
    }
}();
        ...
        ! function() {
            ...
            if (e) {
                ...
                var o = (t.size - t.lineWidth) / 2,
                    s = function(e, t, a) { a = Math.min(Math.max(0, a || 1), 1), i.beginPath(), i.arc(0, 0, o, 0, 2 * Math.PI * a, !1), i.strokeStyle = e, i.lineCap = "round", i.lineWidth = t, i.stroke() };
        ...
        ! function() {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = new ApexCharts(e, { series: [{ name: "Net Profit", data: [35, 25, 45, 15, 60, 50, 57, 35, 70, 40, 45, 25, 45, 30, 70] }], chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 0 }, stroke: { curve: "smooth", show: !0, width: 2, colors: [a] }, xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: a, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, x: { formatter: function(e) { return "Impression " + e } }, y: { formatter: function(e) { return "$" + e + " thousands" } } }, colors: [r], grid: { strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: a, strokeWidth: 2 } });
