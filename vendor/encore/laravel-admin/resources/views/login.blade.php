...
<?php
$bg_url = url(config('admin.login_background_image'));
?>

<body class="hold-transition login-page"
    @if (config('admin.login_background_image')) style="background: url({{ $bg_url }}) no-repeat;background-size: cover;" @endif>
    <div class="login-box">
