<div id="kt_header" style="" class="header  align-items-stretch">
	...
	<div class=" container-fluid  d-flex align-items-stretch justify-content-between">
		<!--begin::Aside mobile toggle-->
					<div class="d-flex align-items-center d-lg-none ms-n3 me-1" data-bs-toggle="tooltip" title="" data-bs-original-title="Show aside menu">
...
<!--end::Svg Icon-->
			...
			<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
				<a href="https://preview.keenthemes.com/metronic8/laravel?mode=light" class="d-lg-none">
					<img alt="Logo" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/logos/logo-1.svg" class="h-15px">
				</a>
			</div>
			<!--end::Mobile logo-->
    ...
    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
        <div class="menu-item me-lg-1"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel?mode=light"><span class="menu-title">Dashboard</span></a></div><div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1"><span class="menu-link py-3"><span class="menu-title">Resources</span><span class="menu-arrow d-lg-none"></span></span><div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px"><div class="menu-item"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel/documentation/getting-started/overview?mode=light"><span class="menu-icon"><!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs027.svg-->
...
<!--end::Svg Icon--></span><span class="menu-title">Documentation</span></a></div><div class="menu-item"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel/documentation/getting-started/changelog?mode=light"><span class="menu-icon"><!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen005.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<!--end::Svg Icon--></span><span class="menu-title">Changelog v8.0.37</span></a></div></div></div><div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1"><span class="menu-link py-3"><span class="menu-title">Account</span><span class="menu-arrow d-lg-none"></span></span><div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px"><div class="menu-item"><a class="menu-link active py-3" href="https://preview.keenthemes.com/metronic8/laravel/account/overview?mode=light"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Overview</span></a></div><div class="menu-item"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel/account/settings?mode=light"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Settings</span></a></div><div class="menu-item"><a class="menu-link py-3" href="#" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="Coming soon"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Security</span></a></div></div></div><div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1"><span class="menu-link py-3"><span class="menu-title">System</span><span class="menu-arrow d-lg-none"></span></span><div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px"><div class="menu-item"><a class="menu-link py-3" href="#" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" data-bs-original-title="Coming soon"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Settings</span></a></div><div class="menu-item"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel/log/audit?mode=light"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Audit Log</span></a></div><div class="menu-item"><a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/laravel/log/system?mode=light"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">System Log</span></a></div></div></div>
    </div>
    <!--end::Menu-->
</div>
                    <!--begin::Menu wrapper-->
    ...
    <div class="scroll-y mh-200px mh-lg-325px">
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/300-6.jpg" alt="">
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/300-2.jpg" alt="">
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/300-9.jpg" alt="">
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/300-14.jpg" alt="">
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/300-11.jpg" alt="">
                        </div>
                        <!--end::Symbol-->
            ...
            <!--end::Category title-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/svg/brand-logos/volicity-9.svg" alt="">
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/svg/brand-logos/tvit.svg" alt="">
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/svg/misc/infography.svg" alt="">
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/svg/brand-logos/leaf.svg" alt="">
                            </span>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                        ...
                        <div class="symbol symbol-40px me-4">
                            <span class="symbol-label bg-light">
                                <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/svg/brand-logos/tower.svg" alt="">
                            </span>
                        </div>
                        <!--end::Symbol-->
...
<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
    ...
    <!--begin::Input group-->
    <div class="mb-5">
        <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-1-d2sd" tabindex="-1" aria-hidden="true">
            <option value="next" data-select2-id="select2-data-3-jczh">Within the next</option>
            <option value="last">Within the last</option>
            <option value="between">Between</option>
            <option value="on">On</option>
        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-2-b93z" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-timezone-tg-container" aria-controls="select2-timezone-tg-container"><span class="select2-selection__rendered" id="select2-timezone-tg-container" role="textbox" aria-readonly="true" title="Within the next">Within the next</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
    </div>
    <!--end::Input group-->
    ...
    <div class="row mb-8">
        ...
        <!--begin::Col-->
        <div class="col-6"> 
            <select name="date_typer" aria-label="Select a Timezone" data-control="select2" data-placeholder="Period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-4-czwv" tabindex="-1" aria-hidden="true">
                <option value="days" data-select2-id="select2-data-6-3x0i">Days</option>
                <option value="weeks">Weeks</option>
                <option value="months">Months</option>
                <option value="years">Years</option>
            </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-5-bslj" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-date_typer-tv-container" aria-controls="select2-date_typer-tv-container"><span class="select2-selection__rendered" id="select2-date_typer-tv-container" role="textbox" aria-readonly="true" title="Days">Days</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
        </div>
        <!--end::Col-->
    </div>
    <!--end::Input group-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('https://preview.keenthemes.com/metronic8/laravel/demo1/media/misc/pattern-1.jpg')">
        <!--begin::Title-->
...
<!--end::Svg Icon-->
			...
			<div class="py-3 text-center border-top">
                <a href="https://preview.keenthemes.com/metronic8/laravel/pages/profile/activity?mode=light" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All
...
<!--end::Svg Icon-->
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <!--begin::Illustration-->
                <img class="mh-200px" alt="metronic" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/illustrations/sketchy-1/1.png">
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
        </div>
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
	<!--begin::Heading-->
    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('https://preview.keenthemes.com/metronic8/laravel/demo1/media/misc/pattern-1.jpg')">
        <!--begin::Title-->
    ...
    <div class="row g-0">
        <!--begin:Item-->
        <div class="col-6">
            <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/budget?mode=light" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
...
<!--end::Svg Icon-->
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/settings?mode=light" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                <!--begin::Svg Icon | path: assets/media/icons/duotune/communication/com010.svg-->
<span class="svg-icon svg-icon-3x svg-icon-success mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path d="M6 8.725C6 8.125 6.4 7.725 7 7.725H14L18 11.725V12.925L22 9.725L12.6 2.225C12.2 1.925 11.7 1.925 11.4 2.225L2 9.725L6 12.925V8.725Z" fill="black"></path>
<path opacity="0.3" d="M22 9.72498V20.725C22 21.325 21.6 21.725 21 21.725H3C2.4 21.725 2 21.325 2 20.725V9.72498L11.4 17.225C11.8 17.525 12.3 17.525 12.6 17.225L22 9.72498ZM15 11.725H18L14 7.72498V10.725C14 11.325 14.4 11.725 15 11.725Z" fill="black"></path>
...
<!--end::Svg Icon-->
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/list?mode=light" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
...
<!--end::Svg Icon-->
        ...
        <!--begin:Item-->
        <div class="col-6">
            <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/users?mode=light" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                <!--begin::Svg Icon | path: assets/media/icons/duotune/finance/fin006.svg-->
<span class="svg-icon svg-icon-3x svg-icon-success mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="black"></path>
<path d="M14 6V5H10V6H8V5C8 3.9 8.9 3 10 3H14C15.1 3 16 3.9 16 5V6H14ZM20 15H14V16C14 16.6 13.5 17 13 17H11C10.5 17 10 16.6 10 16V15H4C3.6 15 3.3 14.9 3 14.7V18C3 19.1 3.9 20 5 20H19C20.1 20 21 19.1 21 18V14.7C20.7 14.9 20.4 15 20 15Z" fill="black"></path>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-primary fw-bold py-4 fs-6 w-200px" data-kt-menu="true" style="">
    ...
    <div class="menu-item px-3 my-1">
        <a href="https://preview.keenthemes.com/metronic8/laravel/account/overview?mode=light" class="menu-link px-3 active">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3 my-1">
        <a href="https://preview.keenthemes.com/metronic8/laravel/account/overview?mode=dark" class="menu-link px-3 ">
            <span class="menu-icon">
    ...
    <!--end::Theme mode-->
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                <img src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/blank.png" alt="user">
            </div>
            <!--begin::Menu-->
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true" style="">
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/avatars/blank.png">
            </div>
            <!--end::Avatar-->
            ...
            <div class="d-flex flex-column">
                ...
                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">demo@demo.com</a>
            </div>
            <!--end::Username-->
        </div>
    </div>
    ...
    <div class="menu-item px-5">
        <a href="https://preview.keenthemes.com/metronic8/laravel/account/settings?mode=light" class="menu-link px-5">
            My Profile
        </a>
    </div>
    <!--end::Menu item-->
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex flex-stack px-5">
                    ...
                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="View your statements" aria-label="View your statements"></i>
                </a>
            </div>
            <!--end::Menu item-->
        ...
        <a href="#" class="menu-link px-5">
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/united-states.svg" alt="metronic">
                </span>
            </span>
        </a>
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5 active">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/united-states.svg" alt="metronic">
                    </span>
                    English
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/spain.svg" alt="metronic">
                    </span>
                    Spanish
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/germany.svg" alt="metronic">
                    </span>
                    German
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/japan.svg" alt="metronic">
                    </span>
                    Japanese
                </a>
            </div>
            ...
            <div class="menu-item px-3">
                <a href="#" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="https://preview.keenthemes.com/metronic8/laravel/demo1/media/flags/france.svg" alt="metronic">
                    </span>
                    French
                </a>
            </div>
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="#" data-action="https://preview.keenthemes.com/metronic8/laravel/logout?mode=light" data-method="post" data-csrf="W7y8YlaiYt5Pn57U8PAeTYghB2Mrymu2bIcQOLZW" data-reload="true" class="button-ajax menu-link px-5">
            Sign Out
        </a>
    </div>
    <!--end::Menu item-->
        ...
        <div class="menu-item px-5">
            <div class="menu-content px-5">
                <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                    <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="skin" id="kt_user_menu_dark_mode_toggle" data-kt-url="https://preview.keenthemes.com/metronic8/laravel?mode=dark">
